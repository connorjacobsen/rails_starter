...
# Use Slim for templating. Read more: http://slim-lang.com/
gem 'slim-rails', '~> 2.1.5'

group :development, :test do
  # Use sqlite3 for the development database.
  gem 'sqlite3', '~> 1.3.9'
  ...
  # Cleans the database after the test suite finishes.
  gem 'database_cleaner', '~> 1.2.0'

  # Annotates the model .rb files with schema details.
  # Read more: https://github.com/ctran/annotate_models
  gem 'annotate', '~> 2.6.3'

  # Faster application loading with spring.
  gem 'spring', '~> 1.1.3'
end
